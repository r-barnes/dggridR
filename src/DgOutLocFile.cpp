...
const std::string DgOutLocFile::defaultKMLName = "";
const std::string DgOutLocFile::defaultKMLDescription = "Generated by DGGRID " DGGRID_VERSION;
...
////////////////////////////////////////////////////////////////////////////////
DgOutLocFile*
DgOutLocFile::makeOutLocFile (const std::string& type, const std::string& fileName,
#ifdef USE_GDAL
...
#endif
                    int shapefileIdLen,
                    const std::string& kmlColor, int kmlWidth,
                    const std::string& kmlName, const std::string& kmlDesc,
